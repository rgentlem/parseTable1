...
3. [ ] Add first-class support for data matrices.
...
4. [ ] Model value semantics beyond count/percent.
...
5. [ ] Strengthen parent/level reasoning.
...
6. [ ] Add golden-paper regression tests.
...
7. [ ] Improve R inspection workflow.
