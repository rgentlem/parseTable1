...
current retained reference run is `outputs/testpapers_batch_20260706_hline_rebuild_v6`.
...
- Recent hline-led extraction update: for credible ruled table candidates with
  ...
  header cells can span adjacent blank value columns. In the latest retained
...
- Recent bibliography baseline update:
  ...
  `outputs/testpapers_batch_20260706_hline_rebuild_v6` as the current
  ...
  numbering-style papers. The same run has 370 resolved / 0 inferred / 0
